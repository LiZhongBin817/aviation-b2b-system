<template>
  <div class="migrate-modify wp">
    <h2>Modify Order / Reschedule</h2>
    ...
    <section class="panel">
      <div class="panel-title">Select flight segments to modify</div>
      <table class="simple-table">
        <thead>
          <tr>
            <th></th>
      ...
      <div class="actions">
        <el-button type="primary" @click="searchAlternatives">Search alternatives</el-button>
    ...
    <section class="panel">
      ...
      <p class="hint">Please submit modifications as early as possible.</p>
    </section>
...
const segments = ref([
  { id: 1, seq: 1, airline: 'OZ', flight: 'QZ222', cabin: 'V', depart: 'ICN', arrive: 'JFK', date: '2026-02-14', newDate: '' },
...
function submitModify() {
  ...
  (window as any).$message?.success ? (window as any).$message.success('Modification submitted.') : alert('Modification submitted.')
}
